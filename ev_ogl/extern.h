...
/* my own ctypes */ 
extern char kb_upper_array[1000];
extern char kb_lower_array[1000];
...
extern char pix_file_name[1000]; /* for P 2 */
...
#ifdef __L_EVOLVER__
extern FILE *l_infd;  /* l_evolver_mode command input file */
extern FILE *l_outfd;  /* l_evolver_mode command output file */
extern FILE *l_brfd;  /* l_evolver_mode break command file */
extern int l_evolver_mode; /* flag to indicate that we are in layered evolver mode*/
extern int l_redirect; /* flag to indicate >> redirect during layer mode */
extern int l_evolver_break; /* flag to help interrupt scripts */
extern char *GraphicsWindowTitleText; /* String to specify the OpenGL window title */
extern char GraphicsWindowTitleTextBuffer[];
extern int ProgramBreakDelay; /* number for -X command line option */
extern int cProgramBreakDelay; /* counter, goes from 0 to ProgramBreakDelay before*/
                               /* checking l_brfd for break request */
extern int ScreenSizeIndex; /* Values increase from 0 to 4 for increasing display area */
				/* Search glutgraph.c for ScreenSizeIndex to find preset values */
extern int levolvertemp;
extern char png_prefix[];
extern char png_name[];
extern char png_full_name[];
extern char png_dir[];
/* Variables to hold window position information passed in on the command line */
extern int y_pixel_down_cmd_line;
extern int y_pixel_height_cmd_line;
extern int x_pixel_width_cmd_line;
#endif
...
extern char set_extra_name[1000]; /* for saving name */
extern int line_no;
...
extern char cmapname[1000];  /* colormap file name */
